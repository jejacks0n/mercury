Mercury.I18n.define 'swedish_chef',
  ...
  # Mercury.Region
  # ---------------------------------------------------------------------------
  "Is unsupported in this browser": "Is unsooppurted in thees brooser" # todo: !
  "Region type not provided": "Regeeun type-a nut prufeeded" # todo: !
  "Unknown %s region type, falling back to base region": "Unknoon %s regeeun type-a, felleeng beck tu bese-a regeeun" # todo: !
  "No name provided for the %s region, falling back to random": "Nu neme-a prufeeded fur zee %s regeeun, felleeng beck tu rundum" # todo: !

  # Mercury.Model.File
  # ---------------------------------------------------------------------------
  "Too large (max %s)": "Tuu lerge-a (mex %s)"
  "Unsupported format (%s)": "Unsupported format (%s)" # todo: partial
  ...
  "Has already been defined in parent frame": "Hes elreedy beee deffeened in perent freme-a" # todo: !
  "Unable to save to the url: %s": "Uneble-a tu sefe-a tu zee url: %s" # todo: partial
  ...
  # Mercury.Uploader
  # ---------------------------------------------------------------------------
  "Error uploading %s: %s": "Errur upluedeeng %s: %s" # todo: !
  ...
  # ---------------------------------------------------------------------------
  "Character Picker": "Cherecter Peecker" # todo: !

  # Mercury.Plugin.Color
  # ---------------------------------------------------------------------------
  "Last Color Picked": "Lest Culur Peecked"

  # Mercury.Plugin.History
  # ---------------------------------------------------------------------------
  "Page Version History": "Pege-a Ferseeun Heestury"

  # Mercury.Plugin.Link
  # ---------------------------------------------------------------------------
  "Link Manager": "Leenk Muneger" # todo: !
  "Can't be blank": "Cun't be-a blunk" # todo: partial
  ...
  # Mercury.Plugin.Media
  # ---------------------------------------------------------------------------
  "Media Manager": "Medeea Muneger" # todo: !
  "Is invalid": "Is infeleed" # todo: !
  "Images": "Imeges"
  "Videos": "Feedeus"
  ...
  "Float": "Fluet" # todo: !
  "Inherit": "Inhereet" # todo: !
  "Width": "Veedt"
  "Height": "Heeeght"
  "Insert Media": "Insert Medeea"

  # Mercury.Plugin.Notes
  # ---------------------------------------------------------------------------
  "Page Notes": "Pege-a Nutes"

  # Mercury.Plugin.Table
  # ---------------------------------------------------------------------------
  "Table Manager": "Teble-a Muneger" # todo: !
  "Rows": "Roos"
  "Columns": "Culoomns"
  "Before": "Beffure-a" # todo: partial
  "After": "Effter" # todo: partial
  "Remove": "Remufe-a"
  "Row Span": "Roo Spun"
  ...
  "Link": "Leenk"
  "Media": "Medeea"
  "Insert Media and Files (images, videos, etc.)": "Insert Medeea und Feeles (imeges, feedeus, itc.)" # todo !
  "Table": "Teble-a"
  ...
  # Mercury.Region.Gallery
  # ---------------------------------------------------------------------------
  "Previous Slide": "Prefeeuoos Sleede-a" # todo !
  "Next Slide": "Next Sleede-a" # todo !
  "Delete Slide": "Delete-a Sleede-a" # todo !
  "Play/Pause": "Pley/Poose-a" # todo !
  ...
  # Mercury.Region.Image
  # ---------------------------------------------------------------------------
  "Crop Image": "Crup Imege-a" # todo !
  "Resize Image": "Reseeze-a Imege-a" # todo !
  "Align Top": "Eleegn Tup" # todo !
  "Align Middle": "Eleegn Meeddle-a" # todo !
  "Align Bottom": "Eleegn Buttum" # todo !
  "Align None": "Eleegn Nune-a" # todo !

  # Mercury.Region.Markdown
  # ---------------------------------------------------------------------------
  "No Heading": "Nu Heedeeng" # todo !
