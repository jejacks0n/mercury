Carmenta = {}
require '/assets/carmenta/history_buffer.js'

describe "Carmenta.HistoryBuffer", ->

  beforeEach ->
    @buffer = new Carmenta.HistoryBuffer(5)
  ...
  describe "#push", ->
    ...
    it "won't duplicate items if the content is the same", ->
      ...
      @buffer.push('2<em class="carmenta-marker"></em>')
      expect(@buffer.stack).toEqual(['1', '2<em class="carmenta-marker"></em>'])
